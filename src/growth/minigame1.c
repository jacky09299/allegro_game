...
static void prepare_audio_recording(void) {
    ...
    printf("DEBUG: Waveform buffer allocated (%d samples, %zu bytes).\n", waveform_buffer_size_samples, (size_t)waveform_buffer_size_samples * sizeof(short)); // Corrected %lu to %zu and cast
